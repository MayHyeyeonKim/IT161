   ...
   <script>
    ...
    <footer>
        <p><small>&copy; 2022 by
          <a href="http://web-students.net/site44/it161/fp/welcome.html">May</a>, All Rights Reserved ~|
          <a id="html-checker" href="https://validator.w3.org/nu/?doc=">Check HTML</a> ~
          <a id="css-checker" href="https://jigsaw.w3.org/css-validator/validator?uri=">Check CSS</a>
          <a href="http://web-students.net/site44/it161/fp/welcome.html#disclasimer">| Disclaimer / Privacy Notice</a>
          </small>
        </p>
      </footer>
</body>
